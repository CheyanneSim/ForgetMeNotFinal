...
public class FirstNotificationHelper extends ContextWrapper {
    public static final String channelID = "channelID";
    public static final String channelName = "Channel Name";

    private NotificationManager mManager;

    public FirstNotificationHelper(Context base) {
        super(base);
    ...
    public NotificationCompat.Builder getChannelNotification(String food, Boolean necessity, long expiry) {
        ...
        // Action: Dismiss - create a new alarm on the expiry date
        Intent dismiss = new Intent(getApplicationContext(), DismissReceiver.class);
        dismiss.putExtra("Necessity", necessity);
        dismiss.putExtra("Food", food);
        dismiss.putExtra("Expiry in ms", expiry);
        PendingIntent dismissIntent = PendingIntent.getBroadcast(getApplicationContext(), food.hashCode(), dismiss, PendingIntent.FLAG_UPDATE_CURRENT);

        return new NotificationCompat.Builder(getApplicationContext(), channelID)
                .setContentTitle("Forget Me Not!")
                .setContentText("Your " + food + " is expiring in 5 days!")
