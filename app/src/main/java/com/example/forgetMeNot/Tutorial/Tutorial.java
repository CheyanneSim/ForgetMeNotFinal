...
public class Tutorial extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        mList.add(new ScreenItem("Sharing Data",
                "Start using Forget Me Not by joining/creating a group of family and friends with whom your data can be shared conveniently with! \n Note that the group name is case sensitive.",
                R.drawable.group));
        mList.add(new ScreenItem("My Necessities",
                "Necessities are items that you need a constant supply of, that is, things that you need to replenish when you run out of them. \n When you run out of these necessities, or if they have expired, they will be added to My Shopping List automatically.",
